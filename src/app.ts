...
const allowedOrigins = [
  'http://localhost:3000',
  'http://localhost:5173',
  'https://fundacionapoyo.netlify.app',
  'https://fundacion-chat-frontend.netlify.app'
];
...
io.on('connection', (socket) => {
  ...
  console.log(`🟢 Usuario conectado: ${user.email} (${user.tipo}) - Socket: ${socket.id}`);
